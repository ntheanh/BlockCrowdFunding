...
const Collections = () => {
  const { getAllCollection, collections, handleDeleCollection } =
    useContext(Context)
  ...
  useEffect(() => {
    setData(
      collections?.slice((page - 1) * resultsPerPage, page * resultsPerPage)
    )
              ...
              {data?.map((collection) => (
                <TableRow key={collection?.id}>
                  <TableCell>
                    <div className="flex items-center text-sm">
                      <Avatar
                        ...
                        src={
                          collection?.attributes?.collectionImg?.data &&
                          collection?.attributes?.collectionImg?.data[0]
                            ?.attributes?.url
                            ? baseURLImg +
                              collection.attributes.collectionImg.data[0]
                                .attributes.url
                  ...
                  <TableCell className="text-sm">
                    {collection?.attributes?.collectionDesc.slice(0, 60)} ...
                  </TableCell>
                  <TableCell>
                    <div className="flex">
