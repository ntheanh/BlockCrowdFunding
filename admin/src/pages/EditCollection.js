...
const EditCollection = () => {
    ...
    const { getCollectionId, collectionId, editCollection, getAllCollection } = useContext(Context)
    ...
    useEffect(() => {
        setUpdatesData(collectionId?.data[0]?.attributes)
    }, [collectionId])
    ...
    const handleEditCollection = async () => {
        await editCollection(id, image, updatesData)
        await getAllCollection()
        history.push("/app/all-collection")
    }
    ...
    return (
        <div>
            ...
            <div className="flex text-gray-800 dark:text-gray-300">
                ...
                {">"}
                <p className="mx-2">Edit Collection</p>
            </div>
                    ...
                    <CardBody>
                            ...
                            <div class="media flex justify-center mt-3">
                                ...
                                <div class="media-img w-1/2 ml-3">
                                    {imageUrl ? (
                                        ...
                                        <img src={`${baseURLImg + updatesData?.collectionImg?.data[0]?.attributes?.url}`} alt="Product Image" className="w-auto h-40" />
                                    )}
                        ...
                        <Label>
                            <Textarea
                                ...
                                onChange={(e) => updateEdit(e)}
                                id="collectionDesc"
                                value={updatesData?.collectionDesc}
                            />
                        </Label>

                        <div className="w-full" onClick={() => handleEditCollection()}>
                    ...
                    <CardBody>
                        ...
                        <Label className="mt-4">
                            ...
                            {show && (
                                <div>
                                    <ul>
                                        {collectionId?.data[0]?.attributes?.products?.data?.map((product) => (
