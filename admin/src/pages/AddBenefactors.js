...
const AddBenefactors = () => {
  ...
  const handleBenefactors = async () => {
    await handleNewBrand(image, updatesData)
    await getAllBrands()
  }
  return (
    <div>
      <PageTitle>Add New Benefactors</PageTitle>
      ...
      <div className="flex text-gray-800 dark:text-gray-300">
        ...
        {">"}
        <p className="mx-2">Add New Benefactors</p>
      </div>
      ...
      <div className="w-full mt-8 grid gap-4 grid-col md:grid-cols-3 ">
        <Card className="row-span-2 md:col-span-2">
          <CardBody>
            ...
            <div className="w-full" onClick={() => handleBenefactors()}>
            ...
            <Label className="mt-4">
              ...
              <Link onClick={() => setShow(!show)}>
                <div className="flex items-center font-medium">
                  <h3 className="mr-6">
                    {1 ? "Hide category" : "Select category"}
                  </h3>{" "}
                  <span>
